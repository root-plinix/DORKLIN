...
os.system("clear")
#hm = argparse.ArgumentParser()
#hm.add_argument("-h" ,"--help" , help = "For show help massage", dest = "help")
#hm.add_argument("-u" ,"--update" , help = "Update DORKLIN",dest = "update")
...
def PBF(banner):
    ...
    print("If you're date are single number so write it with 0")
    d=input("Enter day:")
    if len(d) == 2:
        m=input("Enter month:")
    else:
    ...
    p.write(pn[:10]+"\n")
    p.write(pn[-10:]+"\n")
    #ask dor brute force permission
